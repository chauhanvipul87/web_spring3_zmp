		...
		<center>
			...
			<form id="volumetricweight" name="volumetricweight">
					<table width="100%" border="0" cellpadding="5"
						...
						<tr>
							<th colspan="2" bgcolor="#dedede">International Volume Calculator</th>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><input type="text" name="result" id="result"> Kilos
							</td>
						</tr>
						<tr>
					...
					<p>International parcel sizes are converted into 'dimensional weights' for shipping. 
					Please select the correct services based on whichever is the highest; actual weight or 'dimensional weight'. </p>
