...
var humanMsg = {
	...
	displayMsg: function(msg) {
		...
		// Inject message
		jQuery('#'+humanMsg.msgID).html(msg)
	
		// Show message
		jQuery('#'+humanMsg.msgID+'').show().animate({ opacity: humanMsg.msgOpacity}, 1000, function() {
